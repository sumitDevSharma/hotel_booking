...
<header class="main-header header-style-one">
  ...
  <div class="header-upper">
      <div class="inner-container clearfix">
          <!--Logo-->
          <div class="logo-box">
              <div class="logo"><a href="{{route('home')}}" title="Hotera - Hotel and Restaurant HTML Template"><img
                          src="{{ asset($themeTrue . 'images/logo.png')}}" alt="Hotera - Hotel and Restaurant HTML Template"
  ...
  <div class="mobile-menu">
      ...
      <div class="nav-logo"><a href="{{route('home')}}"><img src="images/nav-logo.png" alt="" title=""></a></div>
      <nav class="menu-box">
      ...
      <div class="nav-bottom">
          <div class="copyright">Hotera © 2020 All Right Reserved</div>
          <!--Social Links-->
