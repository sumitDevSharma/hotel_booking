            ...
            <div class="startbar-collapse" id="startbarCollapse" data-simplebar="">
                <div class="d-flex align-items-start flex-column w-100">
                    ...
                    <ul class="navbar-nav mb-auto w-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#sidebarHotels" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarHotels">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#sidebarRooms" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarRooms">
                                <i class="iconoir-view-grid menu-icon"></i>
                                <span>Rooms</span>
                            </a>
