                        ...
                        <ul class="list-style-none">
                            ...
                            <li>
                                <a class="nav-link pt-3 text-center text-dark notification-clear-btn"
                                    href="javascript:void(0);" v-if="items.length > 0" @click.prevent="readAll">
            ...
            <ul class="navbar-nav float-right">
                        ...
                        <form class="navbar-search-form" onsubmit="return false;">
                            <div class="customize-input">
                                <input class="form-control custom-shadow custom-radius border-0 bg-white" type="search"
                                    name="navbar_search" id="navbar_search" autocomplete="off" placeholder="Search"
                                    aria-label="Search">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                        ...
                        <img src="{{asset_url(Auth::guard('admin')->user()->image)}}"
                            alt="user" class="rounded-circle width-40p">
